...
int main() {
    ...
    std::cout << "Search 'date' in string tree: " << (stringTree.search("date") ? "Found" : "Not Found") << std::endl;
    std::cout << "Search 'mango' in string tree: " << (stringTree.search("mango") ? "Found" : "Not Found") << std::endl;
